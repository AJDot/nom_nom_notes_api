...
module ActiveModelSerializers::Adapter
  ...
  def self.create(resource, options = nil); end
  def self.find_by_name(adapter_name); end
...
class ActiveModelSerializers::Adapter::UnknownAdapterError < ArgumentError
end
class ActiveModelSerializers::Adapter::Base
  def as_json(options = nil); end
  def cache_key; end
  def fragment_cache(cached_hash, non_cached_hash); end
  def initialize(serializer, options = nil); end
  def instance_options; end
  def root; end
  ...
  def serializable_hash(_options = nil); end
...
class ActiveModelSerializers::Adapter::JsonApi < ActiveModelSerializers::Adapter::Base
  ...
  def process_resource(serializer, primary, include_slice = nil); end
  def relationships_for(serializer, requested_associations, include_slice); end
  def resource_object_for(serializer, include_slice = nil); end
  def resource_objects_for(serializers); end
  def self.default_key_transform; end
  def self.fragment_cache(cached_hash, non_cached_hash, root = nil); end
  def serializable_hash(*arg0); end

...
class CarrierWave::SanitizedFile
  ...
  def is_path?; end
  def mime_magic_content_type; end
...
class CarrierWave::Mounter
  ...
  def identifiers; end
  def initialize(record, column, options = nil); end
  ...
  def remove=(arg0); end
  def remove?; end
  def remove_previous(before = nil, after = nil); end
...
class CarrierWave::Uploader::Base
  ...
  def self._after_callbacks=(val); end
  def self._after_callbacks?; end
  def self._before_callbacks; end
  def self._before_callbacks=(val); end
  def self._before_callbacks?; end
  def self._cache_storage; end
  def self._cache_storage=(val); end
  def self._cache_storage?; end
  def self._storage; end
  def self._storage=(val); end
  def self._storage?; end
  ...
  def self.version_names=(val); end
  def self.version_names?; end
  def self.version_options; end
  def self.version_options=(val); end
  def self.version_options?; end
  def self.versions; end
  def self.versions=(val); end
  def self.versions?; end
  def staged; end
  def staged=(arg0); end

...
module GeneratedUrlHelpers
  # Sigs for route /api/v1/recipes(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_recipes_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_recipes_url(*args, **kwargs); end

  # Sigs for route /api/v1/recipes/:id(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_recipe_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_recipe_url(*args, **kwargs); end

  # Sigs for route /api/v1/categories(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_categories_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_categories_url(*args, **kwargs); end

  # Sigs for route /refresh(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def refresh_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def refresh_url(*args, **kwargs); end
